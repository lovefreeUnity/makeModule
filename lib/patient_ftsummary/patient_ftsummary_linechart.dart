...
import 'patient_ftsummary_average.dart';

class PatientFtLineChart extends StatefulWidget {
  const PatientFtLineChart({Key? key}) : super(key: key);
...
class _PatientFtLineChartState extends State<PatientFtLineChart> {
                ...
                LineChartData(
                  ...
                  lineTouchData: LineTouchData(
                      ...
                      touchTooltipData: LineTouchTooltipData(
                        ...
                        tooltipBgColor: Color(0xFFFFFBEF),// MORA/Sub/100 everex_theme에 없다
  ...
  FlDotPainter dotPainter(FlSpot spot, double offsetX, LineChartBarData barData, int index) {
    return FlDotCirclePainter(
        //피그마에 MORA/Sub/500* 라고 적혀 있는데 everex_theme에 있는 값과 다르다.
        color: Color(0xFFFFD850),
        radius: 5,
        strokeWidth: 2,
    ...
    return List<LineTooltipItem>.generate(
      ...
      (index) => LineTooltipItem(
          ...
          moraText.fontSize16.copyWith(
              color: Color(0xFFFDAA2E), fontWeight: FontWeight.w700),
          children: [
            TextSpan(
                text: " 도",
